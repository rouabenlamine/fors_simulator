...
import { Hash, Lock, Eye, EyeOff, Settings, Crown } from "lucide-react";
...
// Only admin roles are allowed on this login page
...
export default function AdminLoginPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center p-6 relative bg-[#001e3d] overflow-hidden">
      ...
      {/* ADMIN BADGE */}
      <div className="relative z-10 mb-4 flex items-center gap-2 px-4 py-1.5 rounded-full bg-amber-500/10 border border-amber-500/20">
        <Lock className="w-3.5 h-3.5 text-amber-400" />
        <span className="text-[10px] font-bold uppercase tracking-widest text-amber-400">Restricted Access Portal</span>
      </div>
