...
import { CheckCircle, XCircle, MessageSquare, RefreshCw, ShieldCheck, ShieldAlert, Send } from "lucide-react";
    ...
    <>
      ...
      {showRejectModal && (
        <div className="fixed inset-0 left-64 z-[1000] flex items-center justify-center p-4">
          <div 
            className="fixed inset-0 left-64 bg-slate-900/40 backdrop-blur-xl transition-all duration-300" 
